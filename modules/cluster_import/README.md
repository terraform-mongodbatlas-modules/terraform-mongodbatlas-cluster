...
- See the [example](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/13_example_import) for a complete working example
