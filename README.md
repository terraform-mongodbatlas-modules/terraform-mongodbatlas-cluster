...
This section guides you through the basic steps to set up Terraform and run this module to create a new [development cluster](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/08_development_cluster) as a practical example.
...
1. Create your Terraform configuration files.
  Ensure your files contain the code provided in this repository:
   ...
   - [main.tf](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/08_development_cluster/README.md/#code-snippet)
   - [variables.tf](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/08_development_cluster/variables.tf)
   - [versions.tf](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/08_development_cluster/versions.tf)
...
--- | --- | ---
REPLICASET | Development | [Development Cluster](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/08_development_cluster)
SHARDED | Production | [Production Cluster with Auto Scaling](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/01_production_cluster_with_auto_scaling)
SHARDED | Production | [Production Cluster with Manual Scaling](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/02_production_cluster_with_manual_scaling)

## Examples

Cluster Type | Name
--- | ---
SHARDED | [Cluster with Analytics Nodes](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/03_cluster_with_analytics_nodes)
REPLICASET | [Cluster with Multi Regions Local (US_EAST_1 + US_EAST_2)](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/04_cluster_with_multi_regions_local)
SHARDED | [Cluster with Multi Regions Global (US+EU)](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/05_cluster_with_multi_regions_global)
GEOSHARDED | [Cluster with Multi Zones (GEOSHARDED)](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/06_cluster_with_multi_zones)
SHARDED | [Cluster with Multi Clouds (AWS+AZURE)](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/07_cluster_with_multi_clouds)
SHARDED | [Cluster using the `replication_specs` to define Cluster Topology](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/09_cluster_using_replication_specs)
GEOSHARDED | [Cluster with Multi Zone and each zone with multiple shards (Advanced)](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/10_cluster_with_multi_zone_multi_shards)
Multiple | [Demonstrate how to create a module "on-top" of the module with a simplified interface (cluster_size=S/M/L)](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/11_module_wrapper_cluster_size)
SHARDED | [Cluster with uniform SHARDED topology using `shard_count`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/examples/12_cluster_uniform_sharded_topology)

<!-- END_TABLES -->

## Cluster Topology Configuration

**For a comprehensive guide on cluster topology configuration, see [Cluster Topology Guide](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/docs/cluster_topology.md), which includes detailed explanations, examples, and migration instructions.**
...
📖 **For detailed guidance on when to use each approach, see the [Cluster Topology Guide](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/docs/cluster_topology.md)**
...
See [Terraform Version Requirements](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.3.1/docs/terraform_version_requirements.md) for detailed explanation.
