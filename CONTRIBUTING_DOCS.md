...
The grouped Inputs section is generated from `docs/inputs_groups.yaml`. To change how variables are grouped:
...
Example README.md files are generated from `docs/example_readme.md` template. To change example documentation:

1. Edit `docs/example_readme.md` template
2. Run `just gen-examples` to regenerate all example READMEs
3. Review and commit changes
...
# Regenerate only root README sections
just gen-readme

# Regenerate only example READMEs
just gen-examples
