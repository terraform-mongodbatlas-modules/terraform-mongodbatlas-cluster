output "advanced_configuration" {
  value       = mongodbatlas_advanced_cluster.this[0].advanced_configuration
  description = "Additional settings for an Atlas cluster."
}

output "backup_enabled" {
  value       = mongodbatlas_advanced_cluster.this[0].backup_enabled
...
output "bi_connector_config" {
  value       = mongodbatlas_advanced_cluster.this[0].bi_connector_config
...
output "bi_connector_config_enabled" {
  value       = mongodbatlas_advanced_cluster.this[0].bi_connector_config == null ? null : mongodbatlas_advanced_cluster.this[0].bi_connector_config.enabled
...
output "bi_connector_config_read_preference" {
  value       = mongodbatlas_advanced_cluster.this[0].bi_connector_config == null ? null : mongodbatlas_advanced_cluster.this[0].bi_connector_config.read_preference
...
output "cluster_id" {
  value       = mongodbatlas_advanced_cluster.this[0].cluster_id
  description = "Unique 24-hexadecimal digit string that identifies the cluster."
}

output "config_server_management_mode" {
  value       = mongodbatlas_advanced_cluster.this[0].config_server_management_mode
  description = <<-EOT
...
output "config_server_type" {
  value       = mongodbatlas_advanced_cluster.this[0].config_server_type
  description = "Describes a sharded cluster's config server type."
}

output "connection_strings" {
  value       = mongodbatlas_advanced_cluster.this[0].connection_strings
  description = "Collection of Uniform Resource Locators that point to the MongoDB database."
}

output "connection_strings_private" {
  value       = mongodbatlas_advanced_cluster.this[0].connection_strings == null ? null : mongodbatlas_advanced_cluster.this[0].connection_strings.private
...
output "connection_strings_private_endpoint" {
  value       = mongodbatlas_advanced_cluster.this[0].connection_strings == null ? null : mongodbatlas_advanced_cluster.this[0].connection_strings.private_endpoint
...
output "connection_strings_private_srv" {
  value       = mongodbatlas_advanced_cluster.this[0].connection_strings == null ? null : mongodbatlas_advanced_cluster.this[0].connection_strings.private_srv
...
output "connection_strings_standard" {
  value       = mongodbatlas_advanced_cluster.this[0].connection_strings == null ? null : mongodbatlas_advanced_cluster.this[0].connection_strings.standard
...
output "connection_strings_standard_srv" {
  value       = mongodbatlas_advanced_cluster.this[0].connection_strings == null ? null : mongodbatlas_advanced_cluster.this[0].connection_strings.standard_srv
...
output "create_date" {
  value       = mongodbatlas_advanced_cluster.this[0].create_date
...
output "delete_on_create_timeout" {
  value       = mongodbatlas_advanced_cluster.this[0].delete_on_create_timeout
...
output "encryption_at_rest_provider" {
  value       = mongodbatlas_advanced_cluster.this[0].encryption_at_rest_provider
...
output "global_cluster_self_managed_sharding" {
  value       = mongodbatlas_advanced_cluster.this[0].global_cluster_self_managed_sharding
  description = <<-EOT
...
output "mongo_db_major_version" {
  value       = mongodbatlas_advanced_cluster.this[0].mongo_db_major_version
  description = <<-EOT
...
output "mongo_db_version" {
  value       = mongodbatlas_advanced_cluster.this[0].mongo_db_version
  description = "Version of MongoDB that the cluster runs."
}

output "paused" {
  value       = mongodbatlas_advanced_cluster.this[0].paused
  description = "Flag that indicates whether the cluster is paused."
}

output "pit_enabled" {
  value       = mongodbatlas_advanced_cluster.this[0].pit_enabled
  description = "Flag that indicates whether the cluster uses continuous cloud backups."
}

output "redact_client_log_data" {
  value       = mongodbatlas_advanced_cluster.this[0].redact_client_log_data
  description = <<-EOT
...
output "replica_set_scaling_strategy" {
  value       = mongodbatlas_advanced_cluster.this[0].replica_set_scaling_strategy
  description = <<-EOT
...
output "root_cert_type" {
  value       = mongodbatlas_advanced_cluster.this[0].root_cert_type
...
output "state_name" {
  value       = mongodbatlas_advanced_cluster.this[0].state_name
...
output "termination_protection_enabled" {
  value       = mongodbatlas_advanced_cluster.this[0].termination_protection_enabled
  description = "Flag that indicates whether termination protection is enabled on the cluster. If set to `true`, MongoDB Cloud won't delete the cluster. If set to `false`, MongoDB Cloud will delete the cluster."
}

output "version_release_system" {
  value       = mongodbatlas_advanced_cluster.this[0].version_release_system
