...
from tf_registry_source import get_registry_source


def transform_submodule_source(
    content: str, registry_source: str, submodule_name: str, version: str | None = None
) -> str:
    """Transform local submodule source paths to registry source in code blocks.

    Replaces patterns like:
        source = "../../modules/cluster_import"
    With:
        source  = "registry_source//modules/cluster_import"
        version = "X.Y.Z"  # if version provided
    """
...
def process_submodule_readme(
    ...
    """Process a submodule README.md file. Returns True if changes were made."""
