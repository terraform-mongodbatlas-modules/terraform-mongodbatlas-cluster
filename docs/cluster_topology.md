...
Most examples in this repository use the simplified `regions` approach. Refer to the [Examples section in the main README](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.4.0/README.md#examples) which provides two organized tables:
...
See [`examples/09_cluster_using_replication_specs`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.4.0/examples/09_cluster_using_replication_specs) for a complete example of using the `replication_specs` variable directly with manual scaling.
...
For troubleshooting common issues and additional help, see the FAQ and Troubleshooting sections in the [main README](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.4.0/README.md#faq).

## Additional Resources

- **[Main Module README](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.4.0/README.md)** - Complete module documentation with all variables and outputs
- **[Examples Directory](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.4.0/examples)** - Working examples for all deployment patterns
