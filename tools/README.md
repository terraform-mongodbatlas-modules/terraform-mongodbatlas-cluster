...
- Or the path is listed in [`.github/sdlc.src.yaml`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.4.1/.github/sdlc.src.yaml).
...
`tools/tf_gen/` exists only in the cluster repository and is not part of SDLC sync. See [tools/tf_gen/README.md](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/blob/v0.4.1/tools/tf_gen/README.md).
