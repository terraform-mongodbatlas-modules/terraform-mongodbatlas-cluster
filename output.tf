...
output "connection_string_private_endpoint" {
  value = mongodbatlas_advanced_cluster.this.connection_strings.private_endpoint != null ? mongodbatlas_advanced_cluster.this.connection_strings.private_endpoint[0].connection_string : null
}
